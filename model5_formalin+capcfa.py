...
project_list.append(['model5_2', 200, None]) 
project_list.append(['model5_3', 300, None]) 
project_list.append(['model5_4', 400, None]) 
project_list.append(['model5_5', 500, None]) 
            ...
            if SE in trainingset:
                if SE in reducing_test_list:
                    for se in range(5):      
                        ...
                        if c11 and not(0.15 < movement[SE,se]): # 
